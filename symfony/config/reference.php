 ...
 *     },
 * }
 * @psalm-type LangsysConfig = array{
 *     api_key?: scalar|Param|null, // Default: "%env(LANGSYS_API_KEY)%"
 *     project_id?: scalar|Param|null, // Default: "%env(LANGSYS_PROJECT_ID)%"
 *     api_url?: scalar|Param|null, // Default: "%env(default:langsys.api_url_default:LANGSYS_API_URL)%"
 *     cache?: array{
 *         pool?: scalar|Param|null, // Default: "cache.app"
 *         prefix?: scalar|Param|null, // Default: "langsys."
 *         ttl?: int|Param, // Default: 3600
 *     },
 *     locale?: array{
 *         sources?: list<scalar|Param|null>,
 *         query_param?: scalar|Param|null, // Default: "locale"
 *         cookie?: scalar|Param|null, // Default: "langsys_locale"
 *         session_key?: scalar|Param|null, // Default: "langsys_locale"
 *         persist?: "cookie"|"session"|Param|null, // Default: "cookie"
 *         supported?: list<scalar|Param|null>,
 *         cookie_minutes?: int|Param, // Default: 525600
 *     },
