...
`getting-started`, `managing-translations`, `translation-memory` and `usage-and-credits` are tutorials, not synthetic cuts: each is one continuous recording
