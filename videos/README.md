...
`getting-started`, `managing-translations`, `translation-memory`, `usage-and-credits`, `adding-a-language` and `one-organization-many-projects` are tutorials, not synthetic cuts: each is one continuous recording
