...
`getting-started`, `managing-translations`, `translation-memory`, `usage-and-credits`, `adding-a-language`, `one-organization-many-projects` and `ai-translator-settings` are tutorials, not synthetic cuts: each is one continuous recording
