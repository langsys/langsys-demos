...
`getting-started`, `managing-translations`, `translation-memory`, `usage-and-credits` and `adding-a-language` are tutorials, not synthetic cuts: each is one continuous recording
