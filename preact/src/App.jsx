...
// The Preact demo app: the React demo's code, VERBATIM, running on Preact via
// @preact/preset-vite's react → preact/compat aliasing. That's the point —
// langsys-js-react needs no changes at all. Only this comment, the topbar
// brand, and the tooling files differ from ../react.
        ...
        <>
            ...
            <div className="app">
                <header className="topbar">
                    <div className="brand">
                        <span className="logo">◆</span> <span translate="no">Langsys</span> × Preact
                    </div>
                    <LocalePills />
                </header>
